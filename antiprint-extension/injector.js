function ScriptContent() {
    ...
    console.debug(new Date().getTime(), "script content finished executing");
}

(function(){
  const scriptEl = document.createElement('script');
  scriptEl.textContent = "(" + ScriptContent.toString() + ")();";
  const docHead = document.head || document.documentElement;
  docHead.appendChild(scriptEl);
  console.debug(new Date().getTime(), "injected script element");
  scriptEl.remove();
})();
