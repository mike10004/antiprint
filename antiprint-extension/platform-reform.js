...
function parseUserAgentSignature(userAgent) {
 ...
 * https://stackoverflow.com/a/18706818/2657036
 */
function _parseUserAgentSignature(nAgt) {
  const unknown = '-';
  const clientStrings = [
  ...
  switch (os) {
      ...
      case 'iOS':
          // TODO: derive this from user agent
          break;
  }
